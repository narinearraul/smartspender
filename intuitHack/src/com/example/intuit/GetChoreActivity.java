...
public class GetChoreActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_get_chores);
		...
		chk1.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
		       ...
		       public void onCheckedChanged(CompoundButton buttonView,boolean isChecked) {
		    	   ...
		    	   chk1.setText(text + "  - waiting for response"); 
		       }
		   }
		); 
		...
		chk2.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
		       ...
		       public void onCheckedChanged(CompoundButton buttonView,boolean isChecked) {
		    	   ...
		    	   chk2.setText(text + "  - waiting for response"); 
		       }
		   }
		); 
		chk3.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
		       ...
		       public void onCheckedChanged(CompoundButton buttonView,boolean isChecked) {
		    	   ...
		    	   chk3.setText(text + "  - waiting for response"); 
		       }
		   }
		); 
		...
		chk4.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
		       ...
		       public void onCheckedChanged(CompoundButton buttonView,boolean isChecked) {
		    	   ...
		    	   chk4.setText(text + "  - waiting for response"); 
		       }
		   }
		); 
		chk5.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
		       ...
		       public void onCheckedChanged(CompoundButton buttonView,boolean isChecked) {
		    	   ...
		    	   chk5.setText(text + "  - waiting for response"); 
		       }
		   }
		); 
		...
		chk6.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
		       ...
		       public void onCheckedChanged(CompoundButton buttonView,boolean isChecked) {
		    	   ...
		    	   chk6.setText(text + "  - waiting for response"); 
		       }
		   }
		); 
    ...
    public class myOnItemSelectedListener implements OnItemSelectedListener {
        ...
        public void onItemSelected(AdapterView<?> parent, View v, int pos, long row) {
        	...
        	GetChoreActivity.this.mPos = pos;
        	GetChoreActivity.this.mSelection = parent.getItemAtPosition(pos).toString();
            /*
